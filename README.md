...
Сервис расчитан на отображение прогноза на 5 дней. Погода обновляется каждые 30 мин.    
В файле config/weather.php указать название город ( текущие настройки для Минска ).    
...
**GET**  http://ваш_домен/api/api/weather/2020/05/15      
